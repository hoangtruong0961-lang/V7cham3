                      ...
                      <div className="flex flex-col gap-3">
                        {cotModules.map((mod) => (
                          <div
                            ...
                            className="flex items-center justify-between p-3 bg-stone-50 dark:bg-slate-900/40 rounded-lg border border-stone-200/80 dark:border-slate-800/80 hover:border-stone-300 dark:hover:border-slate-800 transition-all"
                          >
                            <div className="flex flex-col gap-0.5 pr-4 overflow-hidden">
                              <span className="text-sm font-bold text-stone-800 dark:text-slate-200 flex items-center gap-2">
                                <span className={`w-1.5 h-1.5 rounded-full ${mod.enabled ? "bg-purple-500 animate-pulse" : "bg-stone-400 dark:bg-slate-700"}`}></span>
                                {mod.name || mod.identifier || "Mô-đun CoT chưa đặt tên"}
                              </span>
                              <span className="text-xs text-stone-500 dark:text-slate-400 font-normal line-clamp-1 truncate max-w-[340px]">
                            ...
                            <button
                              ...
                              className={`px-3 py-1.5 rounded-lg text-xs font-bold border transition duration-200 cursor-pointer shrink-0 ${
                                mod.enabled
